...
var pokemonsEL = document.querySelector(".ota_div")
...
for (var i = 0; i < pokemons.length; i++ ){
    ...
    var heightEL = document.createElement("a")
    heightEL.className = 'card-link'
    heightEL.textContent = pokemons[i].height
    pokemonContainer.appendChild(heightEL)

    var weightEL = document.createElement("a")
    weightEL.className = 'card-linkk'
